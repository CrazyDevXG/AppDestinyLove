...
export default function Profile() {
    ...
    return (
      <>
              <Head>
                  <meta charSet="UTF-8"/>
                  <title>Profile User | Destiny Love</title>
                ...
                <div className="py-6 relative">
                    ...
                    <div className="flex md:gap-16 gap-4 max-md:flex-col">
                        ...
                        <div className="max-w-2x flex-1">
                            <h3 className="md:text-xl text-base font-semibold text-black dark:text-white"><span className='font-semibold text-blue-500'><ion-icon name="shield-checkmark" uk-tooltip="Confirmed Account"></ion-icon></span> User Name</h3>                              
                            <p className="sm:text-sm text-gray-600 mt-1 font-normal text-xs"><ion-icon name="flash-off"></ion-icon>Offline</p>                            
                                <p className="text-sm mt-2 md:font-normal font-light">
                                    I love beauty and emotion. 🥰  I hope you like and feel my photos. 😊
                                 </p>
                            ...
                            <div className="mt-8">                              
                                <div className="flex items-center justify-between py-3">
                                    ...
                                    <button type="button" className="lg:hidden">
                                        <svg id="icon__outline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6">
                                            ...
                                            <div className="relative overflow-hidden rounded-lg uk-transition-toggle">
                                                ...
                                                <div className="absolute inset-0 bg-white/5 backdrop-blur-sm uk-transition-fade">    
                                                    <div className="flex items-center justify-center gap-4 text-white w-full h-full">
                                                        <div className="flex items-center gap-2"> <ion-icon className="text-2xl" name="heart-circle"></ion-icon> 152</div>
                                                        <div className="flex items-center gap-2"> <ion-icon className="text-2xl" name="chatbubble-ellipses"></ion-icon> 290</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                    <Link href="#">
                                        <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                            ...
                                            <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                <div className="flex items-center gap-2.5 text-white p-3">
                                                    <ion-icon className="text-2xl" name="play-outline"></ion-icon> 32
                                                </div>
                                            </div>                                    
                                        </div>
                                    </Link>
                                ...
                                <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">
                                    ...
                                    <Link href="#">
                                        <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">
                                            ...
                                            <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                <div className="flex items-center gap-2.5 text-white p-3">
                                                    <ion-icon className="text-2xl" name="play-outline"></ion-icon> 46
                                                </div>
                                            </div>
                                ...
                                <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                    <Link href="#">
                                        <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                            ...
                                            <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                <div className="flex items-center gap-2.5 text-white p-3">
                                                    <ion-icon className="text-2xl" name="play-outline"></ion-icon> 33
                                                </div>
                                            </div>                                    
                                        </div>
                                    </Link>
                                ...
                                <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                    <Link href="#">
                                        <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                            ...
                                            <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                <div className="flex items-center gap-2.5 text-white p-3">
                                                    <ion-icon className="text-2xl" name="play-outline"></ion-icon> 62
                                                </div>
                                            </div>                                    
                                        </div>
                                    </Link>
                                ...
                                <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                    <Link href="#">
                                        <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                            ...
                                            <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                <div className="flex items-center gap-2.5 text-white p-3">
                                                    <ion-icon className="text-2xl" name="play-outline"></ion-icon> 18
                                                </div>
                                            </div>                                    
                                        </div>
                                    </Link>
                                ...
                                <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                    <Link href="#">
                                        <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                            ...
                                            <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                <div className="flex items-center gap-2.5 text-white p-3">
                                                    <ion-icon className="text-2xl" name="play-outline"></ion-icon> 29
                                                </div>
                                            </div>                                    
                                        </div>
                                    </Link>
