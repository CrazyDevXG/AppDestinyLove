                                ...
                                <div className="space-y-4 capitalize text-xs font-normal mt-5 mb-2 text-gray-500 dark:text-white/80">    
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <Link href={navURL("user/profile")}><h4 className="font-semibold text-sm text-black dark:text-white"> User name 1</h4></Link>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <Link href={navURL("user/profile")}><h4 className="font-semibold text-sm text-black dark:text-white"> User name 2</h4></Link>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <Link href={navURL("user/profile")}><h4 className="font-semibold text-sm text-black dark:text-white"> User name 3</h4></Link>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <Link href={navURL("user/profile")}><h4 className="font-semibold text-sm text-black dark:text-white">  User name 4</h4></Link>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <Link href={navURL("user/profile")}><h4 className="font-semibold text-sm text-black dark:text-white">  User name 5</h4></Link>
                                        ...
                                        <ul className="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">                                            
                                            <li className="w-1/2 pr-2">                                            
                                                <div className="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                    ...
                                                    <div className="mt-5 text-center w-full">
                                                        <Link href={navURL("user/profile")}> <h5 className="font-semibold"> Martin Gray</h5> </Link>
                                            ...
                                            <li className="w-1/2 pr-2">
                                                <div className="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                    ...
                                                    <div className="mt-5 text-center w-full">
                                                        <Link href={navURL("user/profile")}> <h5 className="font-semibold"> Alexa Park</h5> </Link>
                                                        <div className="text-xs text-gray-400 mt-0.5 font-medium"> <ion-icon name="male-female"></ion-icon>female : 25</div>
                                                        <button type="button" className="bg-primary block font-semibold text-white mt-4 py-1.5 rounded-lg text-sm w-full border1"> I Like </button>
                                                    </div>
                                                </div>
                                            ...
                                            <li className="w-1/2 pr-2">
                                                <div className="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                    ...
                                                    <div className="mt-5 text-center w-full">
                                                        <Link href={navURL("user/profile")}> <h5 className="font-semibold"> James Lewis</h5> </Link>
